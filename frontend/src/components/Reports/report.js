...
export default function Report() {
  ...
  var w = " ";
    ...
    else if (s == 'Basal cell carcinoma') {
       
      w = dlist[1]

  }
  else if (s == "Benign keratosis-like lesions" ) {
       
    w = dlist[3]

}
else if (s == "Dermatofibroma" ) {
       
  w = dlist[6]

}
else if (s == "Melanocytic nevi" ) {
       
  w = dlist[2]

}
else if (s == "Actinic keratoses" ) {
  ...
  //    axios.get("http://localhost:9000/users/reports/getage")
  //     .then((res, i) => {
  ...
  return (
    <div style={{ width: "50%", margin: "auto" ,border:"2px solid black"}}>
      ...
      >
        ...
        Screening Result: <i><u><b>{s}</b></u></i>
        </p>
        <img
              src={i}
              alt="Skin Scan"
...
{/* 
          ...
          <p style={{fontSize:"15px",fontWeight:"700px"}}></p>
        </div>
        <div
          style={{
            display: "flex",
